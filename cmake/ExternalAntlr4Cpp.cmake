...
message("I HAVE: ${CMAKE_CXX_FLAGS}")
...
set (ALL_CXX_FLAGS "${CMAKE_CXX_FLAGS_${_upper_CMAKE_BUILD_TYPE}}")
...
if(ANTLR4_ZIP_REPOSITORY)
  ExternalProject_Add(
      ...
      CMAKE_CACHE_ARGS
          ...
          -DCMAKE_CXX_FLAGS:STRING=${ALL_THE_CXX_FLAGS}
  ...
  ExternalProject_Add(
      ...
      CMAKE_CACHE_ARGS
          ...
          # -DCMAKE_CXX_STANDARD:STRING=17 # if desired, compile the runtime with a different C++ standard
          -DCMAKE_CXX_STANDARD:STRING=${CMAKE_CXX_STANDARD} # alternatively, compile the runtime with the same C++ standard as the outer project
          -DCMAKE_CXX_FLAGS:STRING=${ALL_CXX_FLAGS}
          -DCMAKE_CXX_COMPILER:STRING=${CMAKE_CXX_COMPILER}
          -DCMAKE_CXX_COMPILER_LAUNCHER:STRING=${CMAKE_CXX_COMPILER_LAUNCHER}
          -DCMAKE_AR:STRING=${CMAKE_AR}
          -DCMAKE_NM:STRING=${CMAKE_NM}
